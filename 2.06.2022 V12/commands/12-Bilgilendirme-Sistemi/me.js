  ...
  ${miniicon} Günlük Mesaj: \`${Number(messageDaily).toLocaleString()} mesaj\`
   `, false);
    ...
    collector.on("collect", async (button) => {
      ...
      ${miniicon} Yetkili Adayları : \`${yetkiData ? yetkiData.yetkis.length : 0} kişi (Puan Etkisi: +${yetkiData ? yetkiData.yetkis.length*8 : 0})\`
...
${miniicon} Yetkili Adayı: (\`Puan Etkisi: +${yetkiData ? yetkiData.yetkis.length*8 : 0}\`)
...
${miniicon} İnsanları yetkili adayı yaparak, \`+8\` puan kazanırsın.

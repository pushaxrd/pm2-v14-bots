...
**vbronze:** (${ayar.vbronze.length > 0 ? `${ayar.vbronze.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**vsilver:** (${ayar.vsilver.length > 0 ? `${ayar.vsilver.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**vgold:** (${ayar.vgold.length > 0 ? `${ayar.vgold.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**vdia:** (${ayar.vdia.length > 0 ? `${ayar.vdia.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**vemerl:** (${ayar.vemerl.length > 0 ? `${ayar.vemerl.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})

**cbronze:** (${ayar.cbronze.length > 0 ? `${ayar.cbronze.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**csilver:** (${ayar.csilver.length > 0 ? `${ayar.csilver.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**cgold:** (${ayar.cgold.length > 0 ? `${ayar.cgold.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**cdia:** (${ayar.cdia.length > 0 ? `${ayar.cdia.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
**cemerl:** (${ayar.cemerl.length > 0 ? `${ayar.cemerl.map(x => `<@&${x}>`).join(",")}` : "\`YOK\`"})
`)
...
**solvingParents:** (${ayar.solvingParents.length ? `<#${ayar.solvingParents}>` : "\`YOK\`"})
`)
...
.addField(`
\`\`\`SİSTEM LOG SETTINGS\`\`\``, `
**rankLog:** (${ayar.rankLog.length ? `<#${ayar.rankLog}>` : "\`YOK\`"})
**prizeLog:** (${ayar.prizeLog.length ? `<#${ayar.prizeLog}>` : "\`YOK\`"})
...
if(["vbronze"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vbronze rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.vbronze = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vbronze rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["vsilver"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vsilver rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.vsilver = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vsilver rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["vgold"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vgold rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.vgold = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vgold rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["vdia"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vdia rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.vdia = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vdia rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["vemerl"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vemerl rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.vemerl = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu vemerl rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}


// ksıım 4

if(["cbronze"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cbronze rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.cbronze = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cbronze rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["csilver"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu csilver rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.csilver = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu csilver rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["cgold"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cgold rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.cgold = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cgold rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["cdia"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cdia rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.cdia = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cdia rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}

if(["cemerl"].some(x => x === choose)) {
    let rol;
    if (message.mentions.roles.size >= 1) {
        rol = message.mentions.roles.map(r => r.id);
    } else {
        if (!rol) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cemerl rolünü belirtmelisin`, message.author, message.channel))
        rol = args.splice(0, 1).map(id => message.guild.roles.cache.get(id)).filter(r => r != undefined);
    }
     pusha.cemerl = rol, await pusha.save() 
     message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu cemerl rolü başarıyla ${rol.map(x => `<@&${x}>`)} olarak ayarlandı`, message.author, message.channel))
}
...
//#region Channel
        ...
        if(["solvingParents",].some(x => x === choose)) {
            let log = message.mentions.channels.first() || message.guild.channels.cache.get(args[1])
            if (!log) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu solvingParents belirtmelisin`, message.author, message.channel))
            pusha.solvingParents = log.id, await pusha.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu solvingParents başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };
...
//kanallar
        ...
        if(["rankLog"].some(x => x === choose)) {
            let log = message.mentions.channels.first() || message.guild.channels.cache.get(args[1])
            if (!log) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu rankLog belirtmelisin`, message.author, message.channel))
            pusha.rankLog = log.id, await pusha.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu rankLog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };

        if(["prizeLog"].some(x => x === choose)) {
            let log = message.mentions.channels.first() || message.guild.channels.cache.get(args[1])
            if (!log) return message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu prizeLog belirtmelisin`, message.author, message.channel))
            pusha.prizeLog = log.id, await pusha.save(), message.channel.send(new Discord.MessageEmbed().setDescription(`Sunucu prizeLog başarıyla ${log} olarak ayarlandı`, message.author, message.channel))
        };

...
module.exports = async (oldState, newState) => {
  ...
  const logKanal = oldState.guild.channels.cache.get(conf.prizeLog);
  const pubVeriler = await userParent.findOne({ guildID: oldState.guild.id, userID: oldState.id, parentID: cfg.katagoriParents });

  if (oldState.guild.roles.cache.get(conf.vbronze) && conf.staffRoles.some((e) => oldState.member.roles.cache.get(e)) && !oldState.member.roles.cache.get(conf.vbronze) && parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(cfg.targetAmount.vbronze) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(cfg.targetAmount.vsilver)) {
    if (logKanal) logKanal.send(`🎉 ${oldState.member.toString()}, \`30 saat ses\` hedefine ulaştığı için \`${oldState.guild.roles.cache.get(conf.vbronze).name}\` rolünü kazandı!`);
    await oldState.member.roles.add(conf.vbronze, `Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vbronze).name}`);``

  } else if (oldState.guild.roles.cache.get(conf.vsilver) && cfg.staffRoles.some((e) => oldState.member.roles.cache.get(e)) && !oldState.member.roles.cache.get(conf.vsilver) && parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(cfg.targetAmount.vsilver) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(cfg.targetAmount.vgold)) {
    if (logKanal) logKanal.send(`🎉 ${oldState.member.toString()}, \`50 saat ses\` hedefine ulaştığı için \`${oldState.guild.roles.cache.get(conf.vsilver).name}\` rolünü kazandı!`);
    await oldState.member.roles.add(conf.vsilver, `Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vsilver).name}`);
    await oldState.member.roles.remove(conf.vbronze, `Eski Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vbronze).name}`);

  } else if (oldState.guild.roles.cache.get(conf.vgold) && cfg.staffRoles.some((e) => oldState.member.roles.cache.get(e)) && !oldState.member.roles.cache.get(conf.vgold) && parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(cfg.targetAmount.vgold) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(cfg.targetAmount.vdia)) {
    if (logKanal) logKanal.send(`🎉 ${oldState.member.toString()}, \`70 saat ses\` hedefine ulaştığı için \`${oldState.guild.roles.cache.get(conf.vgold).name}\` rolünü kazandı!`);
    await oldState.member.roles.add(conf.vgold, `Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vgold).name}`);
    await oldState.member.roles.remove(conf.vsilver, `Eski Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vsilver).name}`);

  } else if (oldState.guild.roles.cache.get(conf.vdia) && cfg.staffRoles.some((e) => oldState.member.roles.cache.get(e)) && !oldState.member.roles.cache.get(conf.vdia) && parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(cfg.targetAmount.vdia) && parseInt(pubVeriler ? pubVeriler.parentData : 0) < ms(cfg.targetAmount.vemerl)) {
    if (logKanal) logKanal.send(`🎉 ${oldState.member.toString()}, \`90 saat ses\` hedefine ulaştığı için \`${oldState.guild.roles.cache.get(conf.vdia).name}\` rolünü kazandı!`);
    await oldState.member.roles.add(conf.vdia, `Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vdia).name}`);
    await oldState.member.roles.remove(conf.vgold, `Eski Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vgold).name}`);

  } else if (oldState.guild.roles.cache.get(conf.vemerl) && cfg.staffRoles.some((e) => oldState.member.roles.cache.get(e)) && !oldState.member.roles.cache.get(conf.vemerl) && parseInt(pubVeriler ? pubVeriler.parentData : 0) > ms(cfg.targetAmount.vemerl)) {
    if (logKanal) logKanal.send(`🎉 ${oldState.member.toString()}, \`120 saat ses\` hedefine ulaştığı için \`${oldState.guild.roles.cache.get(conf.vemerl).name}\` rolünü kazandı!`);
    await oldState.member.roles.add(conf.vemerl, `Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vemerl).name}`);
    await oldState.member.roles.remove(conf.vdia, `Eski Ses Hedef Ödülü | ${oldState.guild.roles.cache.get(conf.vdia).name}`);
}
